...
Ви завжди можете переглянути свій результат тому, що він надійно збрежений у базы данних PostgreSQL : )
                    ...
                    <a href="javascript:void(0);" style="background:#20e277;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Переглянути результат!</a>
                  </td>
                </tr>
                <tr>
                  <td style="height:40px;">&nbsp;</td>
